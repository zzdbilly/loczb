...
const ARTICLE_INDEX = [
  { slug: "how-engineers-report", tags: ["职场", "沟通", "汇报", "思考"], title: "技术人员如何做好汇报" },
  { slug: "quick-energy-recovery", tags: ["能量管理", "情绪", "生活方式", "程序员"], title: "如何快速恢复能量，让自己快乐起来" },
  { slug: "seek-long-term-desires", tags: ["认知科学", "长期主义", "自我管理", "复利思维"], title: "欲望也要看周期：把长期欲望当成你的核心资产" },
  ...
  { slug: "心学不是鸡汤一个程序员的阳明心学实践手册", tags: ["心学", "王阳明", "哲学", "个人成长", "思维方式"], title: "心学不是鸡汤：一个程序员的阳明心学实践手册" },
  { slug: "程序员的注意力管理比时间更稀缺的资源", tags: ["注意力管理", "深度工作", "程序员效率", "认知科学"], title: "程序员的注意力管理：比时间更稀缺的资源" },
  { slug: "如何维持好自己的健康写给程序员的长期运维指南", tags: ["健康", "生活方式", "程序员"], title: "如何维持好自己的健康：写给程序员的长期运维指南" },
  ...
  { slug: "程序员的周五晚上如何有意义地度过", tags: ["思考", "生活方式", "效率"], title: "程序员的周五晚上，如何有意义地度过" },
